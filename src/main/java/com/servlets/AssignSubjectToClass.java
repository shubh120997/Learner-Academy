...
public class AssignSubjectToClass extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			String qryString3 = "update SubjectList  s set s.ClassList=:n where s.Subname=:sn";
			...
			RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/ViewSubjectClass.jsp");
